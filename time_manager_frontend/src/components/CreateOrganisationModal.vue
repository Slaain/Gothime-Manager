<template>
  <div class="modal-overlay">
    <div class="modal">
      <h2 class="text-lg font-semibold mb-4">Create a New Organisation</h2>
      <form @submit.prevent="createOrganisation">
        <div class="mb-4">
          <label for="organisation-name" class="block text-sm font-medium">Organisation Name</label>
          <input
...
export default {
  ...
  methods: {
    ...
    async createOrganisation() {
      try {
        await axios.post('http://localhost:4000/api/organisations', {
