<template>
    ...
    <div class="background flex items-center justify-center">
      ...
      <div class="glassmorphism w-full max-w-lg p-8 space-y-6">
        ...
        <form @submit.prevent="submitForm" class="space-y-4">
          <div>
            ...
            <input
              ...
              class="input-field w-full px-4 text-black py-2 mt-1 border border-black rounded-md focus:outline-none focus:ring-2 focus:ring-black"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="4"
              class="input-field w-full text-black px-4 py-2 mt-1 border border-black rounded-md focus:outline-none focus:ring-2 focus:ring-black"
              required
            ></textarea>
          </div>
          ...
          <div class="flex justify-center">
            <button
              type="submit"
              class="px-6 py-3 font-semibold bg-yellow-400 text-black rounded-md hover:bg-yellow-300"
            >
              Send Message
            </button>
          </div>
  ...
  export default {
    ...
    methods: {
      submitForm() {
        ...
        this.$refs.notification.show("Message sent !"); // Affiche la notification
