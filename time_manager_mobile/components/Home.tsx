...
export default function HelloWave() {
  ...
  const fetchGetUserData = async () => {
    const response = await axios.get(`http://10.79.216.202:4000/api/users/${userId}`)
  ...
  const fetchUserOfOrganization = async () => {
    try {
      ...
      const response = await axios.get(`http://10.79.216.202:4000/api/organisations/${userId}/users`)
  ...
  const fetchGetUserGroup = async () => {
    ...
    try {
      ...
      const response = await axios.get(`http://10.79.216.202:4000/api/groups/user/${userId}`)
  ...
  const getDayWorkingTime = async () => {
    const response = await axios.get(`http://10.79.216.202:4000/api/workingtime/today/${userId}`)
